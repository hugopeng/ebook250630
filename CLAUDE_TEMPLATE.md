...
git init
git config --local user.name "hugopeng"
git config --local user.email "hugopeng@gmail.com"
...
git init && git config --local user.name "hugopeng" && git config --local user.email "hugopeng@gmail.com"
